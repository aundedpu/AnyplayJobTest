...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        [SerializeField] bool ignoreIOSSafeArea = false;
        [SerializeField] bool ignoreAndroidSafeArea = false;
        ...
        void CheckPlatformConform()
        {

            if (Application.platform == RuntimePlatform.Android && ignoreAndroidSafeArea)
            {
                ConformX = false;
                ConformY = false;
            }

            if (Application.platform == RuntimePlatform.IPhonePlayer && ignoreIOSSafeArea)
            {
                ConformX = false;
                ConformY = false;
            }
