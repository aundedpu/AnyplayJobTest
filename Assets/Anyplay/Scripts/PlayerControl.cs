...
namespace Anyplay.Scripts
{
    ...
    public class PlayerControl : NetworkBehaviour , IMovementBehaviour
    {
        ...
        public void ApplyRotation()
        {
            ...
            characterController.transform.rotation = Quaternion.Lerp(characterController.transform.rotation, rotation, Time.deltaTime * smoothRotation);
        }
